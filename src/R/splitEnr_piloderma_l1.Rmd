...
projectFolder <- "/mnt/picea/projects/spruce/vhurry/fungi-flakaliden-2011/fungi-species/piloderma_croceum"
deFolder <- file.path(projectFolder,"DE")

clusterFolder <- file.path(projectFolder,"networks/control/results/aggregated")
clusterFile <- file.path(clusterFolder, "InfomapClusters_l1.tsv")
