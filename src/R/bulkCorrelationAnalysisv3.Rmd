---
title: "Bulk clustering analysis v3"
...
criteriaList <- list(criteria1_pos=criteria1[criteria1$fertilised_score > 0,],
                     criteria1_neg=criteria1[criteria1$fertilised_score < 0,],
                     criteria3_pos=criteria3[criteria3$fertilised_score > 0,],
                     criteria3_neg=criteria3[criteria3$fertilised_score < 0,],
                     criteria4_pos=criteria4[criteria4$fertilised_score > 0,],
                     criteria4_neg=criteria4[criteria4$fertilised_score < 0,]
                     )
