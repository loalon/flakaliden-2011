---
title: "Fungi network analysis - Hyaloscyphaceae - Fertilised"
...
```
# Introduction
This file contains the script and results of the network clustering of the fungi 2011 dataset, for the Hyaloscyphaceae family . 
...
projectDir <- "/mnt/picea/projects/spruce/vhurry/fungi-flakaliden-2011/Hyaloscyphaceae"
...
```{r control}
network = 'fertilised'
seidrFile = "aggregated_0.3784.sf"
...
selectedClusters <- getClusterByMinSize(infomapTable, level='Level2', min=minSize)
