---
title: "Fungi network analysis - Cortinariaceae - Control"
...
```
# Introduction
This file contains the script and results of the network clustering of the fungi 2011 dataset, for the Atheliaceae family . 
...
```{r control}
network = 'control'
seidrFile = "aggregated_0.27304.sf"
theData <- controlData
markovTime <- 1
minSize <- 30
theColors <- c("#009444")
