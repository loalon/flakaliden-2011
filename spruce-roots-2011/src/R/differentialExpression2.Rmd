...
write.table(combinedData, file =paste0(deFolder,"spruceRoots2011Combined.tsv"), sep='\t', row.names=FALSE, col.names=FALSE)
writeLines(colnames(combinedData), con=paste0(deFolder,"spruceRoots2011CombinedNames.txt"))
```
...
write.table(controlData, file = paste0(deFolder,"spruceRoots2011Control.tsv"), sep='\t', row.names=FALSE, col.names=FALSE)
writeLines(colnames(controlData), con=paste0(deFolder,"spruceRoots2011ControlNames.txt"))
...
writeLines(colnames(fertilisedData), con=paste0(deFolder,"spruceRoots2011FertilisedNames.txt"))
