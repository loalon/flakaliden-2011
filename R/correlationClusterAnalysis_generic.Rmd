...
# preload packages for dependencies
library(ggplot2)
...
source(here("scripts/koPathwayDiseasesCleanup/koProcessing.R"))
...
profileSimilarity <- function(data1, data2, clusterData1, clusterData2, 
                              group1, group2, time1, time2, name1, name2, minSize=1){
...
# NOTE! If you want to create artificial clusters comment the next two lines
...
# NOTE! If you want to create artificial clusters comment the next two lines and create a data.frame
# p.e. We ahve an artificial cluster with 10 genes
myCluster <- c("2011.gene316272", "2011.gene123521", "2011.gene141046", "2011.gene265052", 
"2011.gene58913",  "2011.gene237176", "2011.gene291059", "2011.gene70263", "2011.gene203296", "2011.gene6654")
controlFungiClusters <- data.frame(gene=myCluster,
                                   cluster=rep("myCluster1", length(myCluster)))
